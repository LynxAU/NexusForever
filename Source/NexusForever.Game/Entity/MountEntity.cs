...
{
    public class MountEntity : VehicleEntity, IMountEntity
    {
        public override EntityType Type => EntityType.Mount;

        public uint OwnerGuid { get; private set; }
        public PetType MountType { get; private set; }

        /// <summary>
        /// Display info applied to the pilot in the <see cref="ItemSlot.Mount"/> slot.
        /// </summary>
        public ItemDisplayEntry PilotDisplayInfo { get; private set; }
