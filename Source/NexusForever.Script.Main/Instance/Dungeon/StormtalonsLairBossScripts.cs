...
namespace NexusForever.Script.Main.Instance.Dungeon
{
    ...
    // Source: TargetGroup entries for PublicEvent 145 + Creature2.tbl name search.
    ...
    /// <summary>Aethros, Normal difficulty. TG 2586.</summary>
    [ScriptFilterCreatureId(17166u)]
    public class StormtalonsLairAethrosNScript : EncounterBossScript { }

    /// <summary>Aethros, Veteran difficulty. TG 2586.</summary>
    ...
    /// <summary>Stormtalon — final boss, Normal difficulty.</summary>
    [ScriptFilterCreatureId(17163u)]
    public class StormtalonsLairStormtalonNScript : EncounterBossScript { }

    /// <summary>Stormtalon — final boss, Veteran difficulty.</summary>
    [ScriptFilterCreatureId(33406u)]
    public class StormtalonsLairStormtalonVScript : EncounterBossScript { }
}
