...
namespace NexusForever.Script.Main.Instance.Dungeon
{
    ...
    ///   Aethros                — TG 2586 — Creature2Id 17166 (Normal) / 32703 (Veteran)
    ...
    ///   Stormtalon             — Creature2Id 17163 (Normal) / 33406 (Veteran) — final boss
    ///
    /// Both Normal and Veteran creature IDs are tracked; the instance completes when any
    /// 5 distinct creature IDs from the tracked set have died (covers both difficulty modes).
    ///
    /// Spawn data: see WorldDatabaseRepo/Instance/Dungeon/Stormtalons Lair.sql
    /// Source: TargetGroup entries for PublicEvent 145 (WorldId 382) + Creature2.tbl name search.
    /// </summary>
    ...
    public class StormtalonsLairScript : IContentMapScript, IOwnedScript<IContentMapInstance>
    {
        ...
        private static readonly HashSet<uint> BossCreatureIds = new()
        {
            ...
            17163u, 33406u,  // Stormtalon — final boss (Normal, Veteran)
        };

        // Number of distinct boss encounters — 5 regardless of Normal/Veteran.
        ...
        public void OnBossDeath(uint creatureId)
        {
            ...
            // All five boss encounters defeated — instance complete.
            if (owner.Match != null)
